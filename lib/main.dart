...
import 'package:healthcare_app/global.dart';
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return RefreshConfiguration(
          headerBuilder: () => const ClassicHeader(), // 自訂刷新頭部
          // footerBuilder: () => const ClassicFooter(), // 自訂刷新尾部
          hideFooterWhenNotFull: true, // 當清單不滿一頁時,是否隱藏刷新尾部
          headerTriggerDistance: 80, // 觸發刷新的距離
